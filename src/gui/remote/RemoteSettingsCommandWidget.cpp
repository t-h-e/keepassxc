    ...
    , m_ui(new Ui::RemoteSettingsCommandWidget())
{
    ...
    connect(
        m_ui->removeSettingsButton, &QPushButton::clicked, this, &RemoteSettingsCommandWidget::removeCurrentSettings);
    connect(m_ui->settingsListWidget,
            &QListWidget::itemSelectionChanged,
            this,
            &RemoteSettingsCommandWidget::editCurrentSettings);
...
void RemoteSettingsCommandWidget::editCurrentSettings()
{
    ...
    auto* remoteSettings =
        remoteParamsConfig()->getRemoteSettingsEntry(m_ui->settingsListWidget->currentItem()->text());
